...
public class LoanAssistant extends JFrame {
    ...
    Color lightYellow = new Color(255, 255,90);
    ...
    public LoanAssistant() {
        ...
        Font myFont = new Font("SAN SERIF", Font.ITALIC, 16);
    ...
    private void computeButtonActionPerformed(ActionEvent e)
    {
        ...
        if(validateDecimalNumber(balanceTextField)) {
            ...
            JOptionPane.showConfirmDialog(null, "Invalid or empty Loan Balance Entry.\nPlease correct the inserted info.", "Balance Input Error", JOptionPane.DEFAULT_OPTION,JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        ...
        monthlyInterest = interest / 1200;// Computing loan payment
        if(computePayment)
        {
